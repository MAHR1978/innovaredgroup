...
<head>
	...
	<body>
        ...
        <div class="main-menu-area" style="background-color:transparent; !important">
            <div class="container"> 
                <div class="row"> 
                    <div class="col-lg-3"> 
                        <!--<div class="logo">-->
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav main-menu ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('login') }}" target="_blank"><i class="fa fa-user-circle" aria-hidden="true"></i></a>
                                    </li>
                                    <li class="nav-item">
