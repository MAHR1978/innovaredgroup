...
$(document).ready(function($) {
 $("#irPago").click(function(){
    ...
    window.location.href="https://www.innovaredgroup.cl/testVet/public/pago"
 })
...
$('#IngresarHora').on('click', function(e) {
    ...
    $(function() {
        ...
        $valor.change(() =>{
            ...
            const url = `https://www.innovaredgroup.cl/testVet/public/centros/veterinario/`+CentroId;
       //alert(url);
    ...
    function loadHours()
    {
        ...
        const url = `https://www.innovaredgroup.cl/testVet/public/verhoras?dia=${selectedDate}&veterinario_id=${vetId}`;
       //alert(url)
