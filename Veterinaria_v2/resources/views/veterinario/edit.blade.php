...
<div class="card" style="border-color: #E0004D;">
  <div class="card-header" style="background-color: #041E42; color: #fff;">Detalle Veterinario</div>
  <div class="card-body">
    {!! Form::open(['route' => 'veterinario.editar', 'method' => 'POST','id' => 'FormEditVeterinario', 'files' => true]) !!}
    {!! Form::hidden('id', $veterinario->id , ['id' => 'id']) !!}
    <div class="form-row">
