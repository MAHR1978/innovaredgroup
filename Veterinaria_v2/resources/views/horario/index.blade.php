...
@endif
{!! Form::open(['route' => 'horario.store', 'method' => 'POST','id' => 'FormMascota']) !!}
{!! Form::hidden('veterinario_id', $id_decrypt , ['id' => 'veterinario_id']) !!}
    ...
    <div class="card-body">
        <div class="table-responsive">
          ...
          <thead class="thead-light">
            <tr>
              <th scope="col" style="background-color: #041E42; color: #00BFB2;">Día</th>
              <th scope="col" style="background-color: #041E42; color: #00BFB2;">Activo</th>
              <th scope="col" class="text-center" style="background-color: #041E42; color: #00BFB2;">Turno Mañana</th>
              <th scope="col" class="text-center" style="background-color: #041E42; color: #00BFB2;">Turno Tarde</th>
            </tr>
          </thead>
          <tbody>
