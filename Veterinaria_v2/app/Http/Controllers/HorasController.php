...
class HorasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('micuenta.mishoras', compact('horascanceladas','horasatendidas', 'role'));
    }
    ...
    {
        $mi_mascotas = Mascota::where('id_duenio','=',Auth::user()->id)->get();
    ...
    public function getHorasAtendidas($id)
    {
        ...
        'imagen','raza','id_mascota','centro','id_hora','carpeta_mascota','id_duenio','sintomas','diagnostico','tratamiento','examen','carpeta_examenes','duenio_completo','usuario','tipo','mascota'));
    }
    ...
    public function destroy($id)
    {
        ...
        $admin_email ='consultaveterinaria@upv.cl';
