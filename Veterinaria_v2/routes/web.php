...
Route::get('/mascota/table', 'MascotasController@getTableMascotas');
Route::resource('/mascota', 'MascotasController');
Route::post('/mascota-edit', 'MascotasController@editarMascota');
...
Route::get('/centros/{centro}/veterinario','CentrosController@veterinarios');
...
Route::group(['middleware' => 'admin'], function() {
    Route::get('/veterinario/table', 'VeterinariosController@getTableVeterinarios');
