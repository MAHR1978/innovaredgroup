...
<head>
		...
		<title>Contáctanos - Universidad Pedro de Valdivia</title>
        <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i> consultaveterinaria@udalba.cl</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i> 22505 4542 - 2505 4557</a></li>
                        </ul>
                    </div>
                    <div class="col-md-12 col-lg-4">
                        <div class="share-icons">
                            <ul>
                                <li><a href="https://twitter.com/UPV_Chile" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://www.facebook.com/upedrodevaldivia/"  target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.youtube.com/channel/UCx3MYMkqIUm4flvI8SBAywA?view_as=subscriber"  target="_blank"><i class="fa fa-youtube"></i></a></li>
                                <li><a href="https://www.instagram.com/upv_chile/"  target="_blank"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="main-menu-area">
            <div class="container"> 
                <div class="row"> 
                    <div class="col-lg-3"> 
                        <div class="logo">
                            <a href="{{ url('/') }}"><img src="https://www.upv.cl/wp-content/uploads/2019/08/LOGO-nuevo-1.png" alt="Logo"></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            <div class="footer-wid">
                                <a href="index.html" class="footer-logo"><img src="https://www.upv.cl/wp-content/uploads/2019/08/LOGO-nuevo-1.png" alt="logo"></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="footer-wid footer-menu">
                                        ...
                                        <ul>
                                            <li><i class="fa  fa-phone"></i>  &nbsp; 22505 4542 - 2505 4557</li>
                                            <li><i class="fa  fa-envelope"></i>  &nbsp;consultaveterinaria@udalba.cl</li>
                                            <li><i class="fa fa-map-o"></i>  &nbsp;Av. Ejército Libertador 171-177. Santiago</li>
                                            <li><i class="fa  fa-angle-right"></i> Lunes a Viernes : 09:30am - 17:30pm</li>
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="social-icos">    
                                <ul class="list-inline">
                                    <li><a href="https://www.facebook.com/upedrodevaldivia/"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/UPV_Chile"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCx3MYMkqIUm4flvI8SBAywA?view_as=subscriber"><i class="fa fa-youtube"></i></a></li>
                                    <li><a href="https://www.instagram.com/upv_chile/"><i class="fa fa-instagram"></i></a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-5">
                            &copy; Universidad del Alba 2021.
                        </div>
