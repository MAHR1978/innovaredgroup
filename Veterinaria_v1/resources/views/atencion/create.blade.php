...
<div class="content-box mt-20 fadeInUp animated">
    <div class="row no-gutters p-20 align-items-center">
        <div class="col-12 box-title">Ingreso de ateción</div>
    </div>
    <div class="px-20 pb-20">
        {!! Form::open(['route' => 'atencion.store', 'method' => 'POST','id' => 'FormAtencion', 'files' => true]) !!}
        {!! Form::hidden('mascota_id', $id_mascota , ['id' => 'mascota_id']) !!}
        {!! Form::hidden('centro_id', $centro , ['id' => 'centro_id']) !!}
        {!! Form::hidden('id_hora', $id_hora , ['id' => 'id_hora']) !!}
        {!! Form::hidden('carpeta_mascota', $carpeta_mascota , ['id' => 'carpeta_mascota']) !!}
        {!! Form::hidden('nombre_mascota', $nombre_mascota , ['id' => 'nombre_mascota']) !!}
        {!! Form::hidden('duenio_id', $id_duenio , ['id' => 'duenio_id']) !!}
        <div class="card mb-10" style="border-color: #E0004D;">
            <div class="card-header" style="background-color: #041E42; color: #fff;">Datos Dueño Mascota</div>
        ...
        <div class="card mb-10" style="border-color: #E0004D;">
                <div class="card-header" style="background-color: #041E42; color: #fff;">Datos Mascota</div>
                <div class="card-body text-primary">
                    <div class="form-row">
                        <div class="form-group col-md-6">
            ...
            <div class="card mb-10" style="border-color: #E0004D;">
                <div class="card-header" style="background-color: #041E42; color: #fff;">Anamnesis</div>
                <div class="card-body text-primary">
                    <div class="form-group">
            ...
            <div class="card mb-10" style="border-color: #E0004D;">
                <div class="card-header" style="background-color: #041E42; color: #fff;">Indicaciones Medicas </div>
                <div class="card-body text-primary">
                    <div class="form-group">
            ...
            <div class="card mb-10" style="border-color: #E0004D;">
                <div class="card-header" style="background-color: #041E42; color: #fff;">Tratamiento</div>
                <div class="card-body text-primary">
                    <div class="form-group">
            ...
            <div class="card mb-10" style="border-color: #E0004D;" id="Examenes">
                <div class="card-header" style="background-color: #041E42; color: #fff;">Exámen Visual o Recetas</div>
                <div class="card-body text-primary">
                    <div class="form-group">
