        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12" id="hours">
                    @if($intervals)
                    @foreach($intervals['dia'] as $key => $interval)
...
$('input:checkbox').on('click', function() {
  chkId = $(this).val();
  if(chkId == 1){
    var docLocation = '/download/Telemedicina_Concentimiento.pdf';
...
$('#IngresarHora').on('click', function(e) {
    ...
    $(function() {
        ...
        $valor.change(() =>{
            ...
            const url = `/centros/${CentroId}/veterinario`;
    ...
    function loadHours()
    {
        ...
        const url = `/verhoras?dia=${selectedDate}&veterinario_id=${vetId}`;
