...
<div class="card" style="border-color: #E0004D;">
    <div class="card-header" style="background-color: #041E42; color: #fff;">Buscar Ficha</div>
    <div class="card-body text-primary">
        {!! Form::open(['route' => 'fichas', 'method' => 'POST','id' => 'FormBuscarFichas']) !!}
        <div class="form-row">
        ...
        <div class="form-row" id="RutPersona">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="rut" id="rut" maxlength="12" value="{{ old('rut') }}">
            </div>
        </div>
        ...
        <div id="Tabla">
            <table class="table table-sm table-striped table-bordered">
                <thead>
                  <th scope="col" style="background-color: #041E42; color: #fff;">Imagen</th>
                  <th scope="col" style="background-color: #041E42; color: #fff;">Nombre</th>
                  <th scope="col" style="background-color: #041E42; color: #fff;">Ver Ficha</th>
                </thead>
                <tbody id="cuerpo">
                </tbody>
              </table>
          ...
          success: function(respuesta) {
                if (Array.isArray(respuesta.data) && respuesta.data.length) {
                    ...
                    for(var i=0; i<respuesta.data.length; i++){
                        ...
                        var tr = `<tr>
                        <td><img src=/`+respuesta.data[i].imagen+` width=90 height=60></td>
