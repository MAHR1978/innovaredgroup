...
<div class="card" style="border-color: #E0004D;">
    ...
    <div class="card-body">
      ...
      {!! Form::open(['route' => 'reservar', 'method' => 'POST', 'id' => 'FormHora', 'files' => true]) !!}
        <div class="row">
            <div class="col-md-6">
...
$(document).ready(function($) {
  ...
  html:
    ...
    '<li>Envió de comprobante  transferencia a constanza.carrasco@upv.cl</li>' +
    '<li>Banco Itau</li>' +
    '<li>Cuenta Corriente</li>' +
    '<li>Cuenta: Valdivia Servicio Dentales Ltda</li>'+
    '<li>Rut. 76.100.916-8</li>'+
    '<li>Número de Cuenta 210731894</li>'+
    '</ul>',
	width: '800px',
...
$('#IngresarHora').on('click', function(e) {
            ...
            success: function(respuesta) {
              alert(respuesta)
                if (respuesta.message == 'success') {
                    ...
                    .then((value) => {
                      window.location.href ='https://www.innovaredgroup.cl/Veterinaria/public/horas';
                    });
                 }
              },
              error:function(e){
    ...
    $(function() {
        ...
        $valor.change(() =>{
            ...
            const url = `https://www.innovaredgroup.cl/Veterinaria/public/centros/veterinario/`+CentroId;
       //alert(url);
    ...
    function loadHours()
    {
        ...
        const url = `https://www.innovaredgroup.cl/Veterinaria/public/verhoras?dia=${selectedDate}&veterinario_id=${vetId}`;
       //alert(url)
