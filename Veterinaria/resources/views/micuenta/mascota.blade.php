...
{
  var ruta = "https://www.innovaredgroup.cl/Veterinaria/public/mascota/edit/"+id;
  //alert(ruta)
...
$('#EditarMascota').on('click', function(e) {
    e.preventDefault();
      ...
      var url = "https://www.innovaredgroup.cl/Veterinaria/public/mascota-edit/"+id;
  ...
  {
      var url='https://www.innovaredgroup.cl/Veterinaria/public/mascota/'+id
      //alert(url)
      swal({
          title: "Esta Seguro?",
