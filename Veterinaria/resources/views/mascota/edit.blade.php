    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content" style="border-color: #E0004D;">
        ...
        <div class="modal-body">
            {!! Form::open(['id' => 'FormEditMascota', 'method' => 'POST', 'files' => true]) !!}
            {!! Form::hidden('id_mascota', false , ['id' => 'id_mascota']) !!}
            {!! Form::hidden('carpeta', false , ['id' => 'carpeta']) !!}
            <div class="form-row">
              ...
              <div class="col-md-6 mb-16">
                <div class="form-group">
                  <label for="inputPassword3">Edad</label>
                    <input type="text" class="form-control" name="edad" id="edades" onkeypress="return numeros(event)" maxlength="2">
                </div>
              </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="col-md-6 mb-16">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="peso" id="pesos" placeholder="00.0">
                  </div>
                </div>
                <div class="col-md-6 mb-16">
                  <div class="form-group">
