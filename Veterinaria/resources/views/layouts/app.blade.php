...
<head>
    ...
    <!--public_html/Veterinaria/public/dashboard/css-->
          ...
          <!--<script src="https://innovaredgroup.cl/Veterinaria/public/dashboard/js/app.js" type="text/javascript"></script>-->
            <link rel="stylesheet" href="../public/dashboard/css/main.css"> 
                <link rel="stylesheet" href="../dashboard/css/main.css">
                    <!--<link rel="stylesheet" href="https://innovaredgroup.cl/Veterinaria/public/dashboard/css/main.css" >-->
    ...
    <!--{!! Html::style('https://innovaredgroup.cl/Veterinaria/public/dashboard/css/main.css') !!}-->
</head>
<body>
    <div id="app">
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js"></script>
  ...
  <script type="text/javascript" src="'https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
	...
	<script type="text/javascript" src="https://unpkg.com/gijgo@1.9.13/js/messages/messages.es-es.j"></script>
	@yield('scripts')
	<script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap4.min.js"></script>
    <!--<script src="https://innovaredgroup.cl/Veterinaria/public/dashboard/js/app.js" type="text/javascript"></script>-->
    <!--{!! Html::script('https://innovaredgroup.cl/Veterinaria/public/dashboard/js/app.js"') !!}-->"
