...
<link rel="icon" href="#" sizes="32x32" />
		...
		<!-- jQuery min js -->
        <script src="../public/template/assets/js/jquery-1.12.4.min.js"></script>
        ...
        <style>
            ...
            .slide-bg-1 {
                background-image: url(https://www.innovaredgroup.cl/Veterinaria/public/template/assets/img/blog-item-4.jpg);
            }
        </style>
	</head>
	...
	<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3">
                        <div class="share-icons">
                            <ul>
                                <li><a href="https://twitter.com/Udalba_Chile" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://m.facebook.com/udelalba/"  target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.youtube.com/channel/UCtzb8MOdja78kFHQz9Th1Gw/featured"  target="_blank"><i class="fa fa-youtube"></i></a></li>
                                <li><a href="https://www.instagram.com/udalba/?utm_medium=copy_link" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="main-menu-area" style="background-color:#808080;">
            <div class="container"> 
                <div class="row"> 
                    <div class="col-lg-3"> 
                        <!--<div class="logo">-->
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav main-menu ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('login') }}" target="_blank"><i class="fa fa-user-circle-o"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('register') }}" target="_blank"><i class="fa fa-user-plus"></i></a>
                                    </li>
                                </ul>
                            </div><!-- /.navbar-collapse -->   
                        </nav>
            ...
            <div class="container">
                <div class="row">
                   <div class="col-lg-6 offset-lg-3">
                       <div class="section-title text-center">
                           <h2><span>Teleconsulta  Preventiva y Acompañamiento Médico Veterinario</span></h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="featured-boxed text-center">
                           <div class="icon-boxed">
                                <a href="{{ url('/contacto') }}" target="_blank"><img src="../public/template/assets/img/Pet-1.png" alt="dog-1"></a>
                            </div>
                            <h3>Contáctanos</h3>
                            <div class="upper-line"></div>
                            <div class="bottom-line"></div>
                            <p>Estimado Usuario  si quiere comunicarse con telemedicina veterinaria, por favor acceda al formulario.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="featured-boxed text-center">
                            <div class="icon-boxed">
                                <a href="{{ url('/login') }}" target="_blank"><img src="../public/template/assets/img/Pet2.png" alt="dog-1"></a>
                            </div>
                            <h3>Agendar Hora</h3>
                            <div class="upper-line"></div>
                            <div class="bottom-line"></div>
                            <p>Estimado Usuario antes de generar su hora médica, deberá tener disponible el archivo de trasferencia para poder adjuntar.</p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 text-center" style="background-color:#808080;">
                            <div class="social-icos">    
                                <ul class="list-inline">
                                    <li><a href="https://m.facebook.com/udelalba/"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/Udalba_Chile"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCtzb8MOdja78kFHQz9Th1Gw/featured"><i class="fa fa-youtube"></i></a></li>
                                    <li><a href="https://www.instagram.com/udalba/?utm_medium=copy_link"><i class="fa fa-instagram"></i></a></li>
