...
class VeterinariosController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $veterinario = User::find($id_decrypt);
   ...
   /* public function getTableVeterinarios()
    {
        $veterinario =User::select('name','apellido_paterno','apellido_materno')->where('role','=','medico')->get();
        //echo $veterinario; 
        return view('veterinario.index',compact('veterinario'));
         //Datatables()->of($veterinario)
